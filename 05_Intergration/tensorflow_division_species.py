# 참고사이트 - https://github.com/golbin/TensorFlow-Tutorials/blob/master/04%20-%20Neural%20Network%20Basic/01%20-%20Classification.py#L31
'''
# 예제 소스에 session.run 부분에 오류가 있다고 함!!!
# 수업때 배운거 아님..
'''
